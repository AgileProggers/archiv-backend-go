...
func (eq *EmoteQuery) QueryProvider() *ProviderQuery {
	query := &ProviderQuery{config: eq.config}
...
// Returns a *NotSingularError when more than one Emote entity is found.
...
// Returns a *NotSingularError when more than one Emote ID is found.
...
func (eq *EmoteQuery) Clone() *EmoteQuery {
	...
	return &EmoteQuery{
		...
		withProvider: eq.withProvider.Clone(),
...
func (eq *EmoteQuery) WithProvider(opts ...func(*ProviderQuery)) *EmoteQuery {
	query := &ProviderQuery{config: eq.config}
	for _, opt := range opts {
		opt(query)
	}
	eq.withProvider = query
	return eq
}
...
//		Scan(ctx, &v)
//
func (eq *EmoteQuery) Select(fields ...string) *EmoteSelect {
...
func (eq *EmoteQuery) sqlAll(ctx context.Context) ([]*Emote, error) {
	...
	if query := eq.withProvider; query != nil {
		ids := make([]int, 0, len(nodes))
		nodeids := make(map[int][]*Emote)
		for i := range nodes {
			if nodes[i].provider_emotes == nil {
				continue
			}
			fk := *nodes[i].provider_emotes
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "provider_emotes" returned %v`, n.ID)
			}
			for i := range nodes {
...
func (egb *EmoteGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(egb.fields) > 1 {
		return nil, errors.New("ent: EmoteGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := egb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (egb *EmoteGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{emote.Label}
	default:
		err = fmt.Errorf("ent: EmoteGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (egb *EmoteGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(egb.fields) > 1 {
		return nil, errors.New("ent: EmoteGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := egb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (egb *EmoteGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{emote.Label}
	default:
		err = fmt.Errorf("ent: EmoteGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (egb *EmoteGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(egb.fields) > 1 {
		return nil, errors.New("ent: EmoteGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := egb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (egb *EmoteGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{emote.Label}
	default:
		err = fmt.Errorf("ent: EmoteGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (egb *EmoteGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(egb.fields) > 1 {
		return nil, errors.New("ent: EmoteGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := egb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (egb *EmoteGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{emote.Label}
	default:
		err = fmt.Errorf("ent: EmoteGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (es *EmoteSelect) Strings(ctx context.Context) ([]string, error) {
	if len(es.fields) > 1 {
		return nil, errors.New("ent: EmoteSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := es.Scan(ctx, &v); err != nil {
		return nil, err
...
func (es *EmoteSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{emote.Label}
	default:
		err = fmt.Errorf("ent: EmoteSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (es *EmoteSelect) Ints(ctx context.Context) ([]int, error) {
	if len(es.fields) > 1 {
		return nil, errors.New("ent: EmoteSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := es.Scan(ctx, &v); err != nil {
		return nil, err
...
func (es *EmoteSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{emote.Label}
	default:
		err = fmt.Errorf("ent: EmoteSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (es *EmoteSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(es.fields) > 1 {
		return nil, errors.New("ent: EmoteSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := es.Scan(ctx, &v); err != nil {
		return nil, err
...
func (es *EmoteSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{emote.Label}
	default:
		err = fmt.Errorf("ent: EmoteSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (es *EmoteSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(es.fields) > 1 {
		return nil, errors.New("ent: EmoteSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := es.Scan(ctx, &v); err != nil {
		return nil, err
...
func (es *EmoteSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{emote.Label}
	default:
		err = fmt.Errorf("ent: EmoteSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
